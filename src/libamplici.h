...
int amplici_wfile(char *fastq_file, char *error_profile_name, double low_bound, data_t **seeds, unsigned int **seeds_length,
...
int amplici_core(data_t **dmat, data_t **qmat, size_t sample_size, double low_bound, unsigned int max_read_length,
                 char *error_profile_name, data_t max_quality, data_t min_quality, data_t **seeds, unsigned int **seeds_length,
