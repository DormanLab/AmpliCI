 ...
 * @author Xiyu Peng
 *
 * File for calling amplici_core function
 *
...
/* more flexiable way to use amplici */
int amplici_core(data_t **dmat, data_t **qmat, size_t sample_size, unsigned int rlen, double *error_profile, unsigned int n_quality, data_t ***seeds, 
                unsigned int **seeds_length, unsigned int **cluster_id, unsigned int **cluster_size, unsigned int *K)
{
